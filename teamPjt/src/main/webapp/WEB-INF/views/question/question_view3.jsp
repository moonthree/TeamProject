...
<body>
  ...
  <ul class="icons3">
    <li>
      ...
      <div class="contents1_bold">wa 배송 상품이란 펀딩에서 인정받은 리워드를 Petdding이 스토어에서 직접 판매하는 상품입니다.</div>
      <div class="contents2">
        Petdding 펀딩에서 검증 된 상품 보다 빠르게, 책임 환불제를 통해 믿고 사실 수 있도록 준비했어요!<br>
        wa 배송 상품/배송/환불 문의는 언제든 Petdding에 문의해주세요.<br>
