...
<div class="main_text0">
      ...
      <ul class="icons2">
        <li>
          ...
          <div class="contents1_bold">스토어 판매를 중단/재개하고 싶으면 어떻게 하나요?</div>
          <div class="contents2">
               스토어 판매를 중단하거나 재개하고 싶다면[스토어]판매 중단/재개 요청서를 접수해 주세요.
          </div>
          <div class="more1">
    ...
    <ul class="icons2">
      ...
      <li>
        ...
        <div class="contents2">
            입점 후 수정이 불가능한 항목들이 있어요. 상품 정보는 꼼꼼히 확인해 주세요.
        </div>
        <div class="more1">
  ...
  <ul class="icons2">
    <li>
      ...
      <div class="contents2">
          기존 펀딩 프로젝트와 다른 리워드는 스토어 입점이 어려울 수 있어요.
      </div>
      <div class="more1">
  ...
  <div class="hk">
	...
	<ul>
		...
		<li>★ 펫띵 스토어상담 : help.store@wadiz.kr</li>
