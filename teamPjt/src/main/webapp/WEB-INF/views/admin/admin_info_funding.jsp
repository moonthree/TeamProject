                ...
                <!-- 드롭 다운  -->
                    <div class="col-sm" style="text-align: right;">            
                        <select id="condition" name="condition" class="condition form-select" onchange="if(this.value) location.href=(this.value);">
			                ...
			                <option value="info_funding.do?curridx=${member.member_idx }&funding_state=0" ${param.funding_state eq 0 ? 'selected' : ''}>결제 예약</option>
			                <option value="info_funding.do?curridx=${member.member_idx }&funding_state=1" ${param.funding_state eq 1 ? 'selected' : ''}>결제 완료</option>
			                <option value="info_funding.do?curridx=${member.member_idx }&funding_state=2" ${param.funding_state eq 2 ? 'selected' : ''}>결제 취소</option>
			            </select>
                    </div>
                </div>
