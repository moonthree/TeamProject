	...
	<div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="#">
                <img src="resources/image/111.png" width="100" height="75" alt="">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="navtext" href="#">펀딩</a>
                    </li>
                    <li class="nav-item">
                        <a class="navtext" href="#">스토어</a>
                    </li>
                ...
                <a href="#" style="margin-left: 10px; margin-right: 10px;">로그인</a>
                <a href="#">회원가입</a>
            </div>
        </nav>
    </div>
