        ...
        <div style="border: 1px solid lightgray;">
            <div class="container">
                <div class="row" style="align-items: center; line-height: 3;">
                    ...
                    <div class="col-lg-2 col-sm-6">
                        <div>
                            <ul class="nav-item dropdown" style="padding-left: 0px; margin: 0 auto;">
                                <a class="nav-link dropdown-toggle footer_a" href="#" id="navbarScrollingDropdown" role="button" data-toggle="dropdown" aria-expanded="false">
                                    SNS
                                </a>
                                <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                                    <li>
                                        <a href="https://www.youtube.com/" class="footer_a">
                                    ...
                                    <li>
                                        <a href="https://www.instagram.com/" class="footer_a">
                                    ...
                                    <li>
                                        <a href="https://twitter.com/" class="footer_a">
                    ...
                    <div class="col-lg-2 col-sm-6">
                        <ul class="nav-item dropdown" style="padding-left: 0px; margin: 0 auto;">
                            <a class="nav-link dropdown-toggle footer_a" href="#" id="navbarScrollingDropdown" role="button" data-toggle="dropdown"
                                aria-expanded="false">
                               	 제휴문의
                            </a>
                            <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
