            ...
            <div class="col-md-12 col-sm-12">
                ...
                <!-- 드롭 다운  -->
                    <div class="col-sm" style="text-align: right;">
                            ...
                            <c:choose>
                           		<c:when test="${ param.funding_state == 0}">
                           			<select name="fruits" class="select" onchange="if(this.value) location.href=(this.value);">
									  <option value="info_funding.do">전체 펀딩</option>
									  <option value="info_funding.do?funding_state=0" selected>결제 예약</option>
									  <option value="info_funding.do?funding_state=1">결제 완료</option>
									  <option value="info_funding.do?funding_state=2">결제 실패</option>
									</select>
                           		</c:when>
                           		<c:when test="${ param.funding_state == 1}">
                           			<select name="fruits" class="select" onchange="if(this.value) location.href=(this.value);">
									  <option value="info_funding.do">전체 펀딩</option>
									  <option value="info_funding.do?funding_state=0">결제 예약</option>
									  <option value="info_funding.do?funding_state=1" selected>결제 완료</option>
									  <option value="info_funding.do?funding_state=2">결제 실패</option>
									</select>
                           		</c:when>
                           		<c:when test="${ param.funding_state == 2}">
                           			<select name="fruits" class="select" onchange="if(this.value) location.href=(this.value);">
									  <option value="info_funding.do">전체 펀딩</option>
									  <option value="info_funding.do?funding_state=0">결제 예약</option>
									  <option value="info_funding.do?funding_state=1">결제 완료</option>
									  <option value="info_funding.do?funding_state=2" selected>결제 실패</option>
									</select>
                           		</c:when>
                           		<c:otherwise>
                           			<select name="fruits" class="select" onchange="if(this.value) location.href=(this.value);">
			                  ...
			                  <div class="col-md-8 col-sm-12">
			                    <table class="table">
			                      <thead class="table-light" style="border-bottom: 2px solid gray;">
			                        ...
			                        <tr>
			                        	<td>
			                        	<div style="font-size: small; color:#737373">
			                        		후원일 
			                        ...
			                        <tr>
			                            ...
			                            <h4>
			                            	<c:choose>
			                            		...
			                            		<c:otherwise>종료된 펀딩입니다</c:otherwise>
			                            	</c:choose>
			                            </h4>
			                            </td>
			                        </tr>
