                ...
                <div id="div_main">
                    <table class="tablelist" id="Table" style='width:100%'>
                        ...
                        <!-- 펀딩 옵션  name 맞춤-->
                            ...
                            <td><input name="funding_option_price" type="number" max="1000000000" class="text"  style="width:100%;"  placeholder="금액" value="${item.funding_option_price}" disabled="disabled"/></td>
                            ...
                            <td><input name="funding_option_stock" type="number"  max="10000" class="text"  style="width:100%;" placeholder="현재 수량" value="${item.funding_option_stock}" disabled="disabled"/></td>
...
<script type="text/javascript">
	  ...
	  function PlusFn (obj){
	    ...
	    newP.innerHTML = "<input type='number' min='1' max='9999' maxlength='4' oninput='maxLengthCheck(this)' class='temp' name='funding_option_plus'> <input type='button' value='취소' class='temp' onclick='remove(this)'>";
	    box.append(newP);
	}
	function remove(obj){
		var Iam = $(obj).parent();
