...
<!-- 부트스트랩 드랍다운 작동하게 해주는 자바스크립트 -->
    ...
    var checkKakao = '${kakaoVo}';
   /* alert(checkKakao);
   console.log(checkKakao); 
    */
   if(checkKakao=="" || checkKakao==null){
            ...
            <div class="col-sm-12" style="text-align: left;">
               ...
               <c:if test="${kakaoVo != null}">카카오로 회원가입</c:if>
                ...
                <form id="mem_frm" name="mem_frm" action="join_seller.do" method="post" accept-charset="utf-8">
					...
					<div class="alert alert-danger" id="alert-dangerPhone">핸드폰 번호을 맞춰주세요!</div>
                    ...
                    <div class="form-group form-check">
                        ...
                        <div id="my_modal" style="text-align: left">
							 <div style="font-weight: bold; font-size: 22px;">Petdding 이용 약관 동의</div>
							    <hr>
								Petdding(주)의 펀딩 · 스토어 서비스 소비자 이용약관을 규정합니다.<br>
								...
								제1장 펀딩 서비스<br>
								제1조 (목적)<br>
								본 장의 약관은 petdding 주식회사(이하 "회사")와 회사가 제공하는 리워드형 크라우드펀딩 중개 서비스를 이용하는 소비자 간의 서비스 이용에 관한 권리·의무 관련 사항을 정함을 그 목적으로 합니다.<br>
								...
								* 홈페이지 : 본 약관에 따라 회사가 제공하는 서비스가 구현되는 온라인상의 웹페이지를 말합니다.<br>
								* 판매자 : 회사와 별도의 이용계약을 체결하고 홈페이지에서 펀딩 서비스 판매자 이용약관에 따른 프로젝트를 개설하여 소비자들로부터 펀딩을 받으려는 자를 말합니다.<br>
								* 소비자 : 회사의 회원가입약관에 따른 회원 중에서 판매자가 개설한 프로젝트에 펀딩을 하려는 자를 말합니다.<br>
								* 펀딩 : 소비자가 판매자에게 일정한 자금을 제공하는 부담을 지고 판매자가 약속한 유형의 제품 또는 무형의 서비스를 제공받는 행위를 의미합니다.<br>
								* 성공 : 펀딩기간의 종료시점을 기준으로 소비자의 펀딩 신청에 따라 모집된 결제예약금 합계액이 판매자가 설정한 목표 금액 이상인 경우를 의미합니다.<br>
								* 실패 : 펀딩기간의 종료시점을 기준으로 소비자의 펀딩 신청에 따라 모집된 결제예약금 합계액이 판매자가 설정한 목표 금액 미만인 경우를 의미합니다.<br>
								* 리워드 : 판매자가 펀딩과 관련하여 소비자로부터 자금을 받으면서 소비자에게 제공하기로 약속한 유형의 제품 또는 무형의 서비스를 의미합니다.<br>
								* 프로젝트 : 판매자가 소비자에게 리워드 제공을 약속하고 펀딩을 통해 자금을 모으기 위하여 회사의 승인을 받아 회사의 홈페이지에 개설한 페이지 및 이를 통해 소비자에게 약속한 내용을 의미합니다.<br>
								* 펀딩의 신청 : 소비자가 프로젝트의 펀딩 기간 내에 회사가 정한 방법에 따라 펀딩의 의사표시를 하는 것을 말합니다.<br>
								* 펀딩의 취소 : 소비자가 프로젝트의 펀딩기간 내에 펀딩의 의사표시를 철회하는 것을 말합니다.<br>
								* 펀딩 달성률 : 소비자가 목표한 금액을 기준으로 펀딩의 신청 접수가 완료된 결제예약금이 차지하는 비율을 말합니다.<br>
								* 결제예약금 : 소비자가 펀딩의 신청에 따라 결제를 예약한 금액을 의미합니다.<br>
								* 결제 취소 : 소비자가 프로젝트 종료 후 리워드의 발송 또는 제공 전까지 회사가 정한 특별한 사유가 있는 경우에 한하여 카드결제 등의 결제 취소를 요청함으로써 펀딩의 의사표시를 철회하는 것을 말합니다.<br>
                        ...
                        <label class="form-check-label" for="exampleCheck2">개인정보 수집, 이용 동의</label>
                         <div id="my_modal2" style="text-align: left">
							 <div style="font-weight: bold; font-size: 22px;">개인정보 제3자 제공 동의</div>
							    <hr>
<pre>Petdding(주)(이하 “회사")가 제공하는 서비스에 회원가입 신청하시는 분께 수집하는 
...
회원 정보, 서비스 이용 내역 </pre>
								...
								펀딩에 참여하여 Petdding의 서비스를 제공받고 있는 중인 회원의 권익보호를 위하여 휴면 상태로 전환되지 않습니다.
