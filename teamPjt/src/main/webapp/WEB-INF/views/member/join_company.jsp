            ...
            <div class="col-sm-12" style="text-align: left;">
               ...
               <c:if test="${kakaoVo != null}">카카오로 회원가입</c:if>
                ...
                <!--     <div class="form-group">
                        ...
                        <div class="form-inline">
                            <input  name="member_addr"   type="text" class="form-control" id="exampleFormControlInput2" placeholder="주소 입력" style="width: 68%;"> &nbsp;
                    ...
                    <div class="form-group"> 
                     <label for="exampleFormControlInput1">주소</label>
                     <!-- <input  name="member_addr"   type="hidden" class="form-control" id="exampleFormControlInput2" placeholder="주소 입력" style="width: 68%;"> &nbsp;            -->       
						...
						<div class="form-group">
						    ...
						    <input name="member_addr2"   placeholder="상세주소" id="addr3" type="text"  />
					</div>
